...
import (
	...
	"golang-project/project/cache-proxy/internal/cache"
)
...
// 		Using simple key for now example GET method on dummyjson.com
// 		CACHE_KEY = GET:https:/dummyjson.com
//
// If Yes -> Respond with the cache http.Response and Body
// 		Set the Headers
// 		X-Cache ; HIT
//
